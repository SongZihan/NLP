...
if __name__ == '__main__':
    ...
    with console.status("[bold green]Processing...[/bold green]") as status:
        ...
        padded_sequences = np.array([np.pad(seq, (0, max_length - len(seq)), mode='constant') for seq in processed_text],dtype=np.int32)
        ...
        console.log("[italic green]Dataset split![/italic green]")
        # 构建 pytorch Dataset
